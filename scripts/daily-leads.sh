...
run_perplexity() {
    ...
    local PROMPT="Search for $LEADS_PER_LOCAL $QUERY businesses. For each business find: 1) Real contact email from their website Contact/About page or Google listing 2) Phone number 3) Owner first name if available 4) Google Maps star rating e.g. 4.2 5) Approximate review count e.g. 47 reviews 6) Whether they have online booking like Calendly or Acuity - yes or no 7) Business hours - do they close before 6pm or on weekends 8) Whether they have a real website or just a Facebook page. Only include businesses with a confirmed real email. Return ONLY a valid JSON array, no markdown, no explanation: [{\"business\":\"Name\",\"website\":\"https://...\",\"email\":\"info@...\",\"name\":\"FirstName\",\"phone\":\"\",\"rating\":\"4.2\",\"reviews\":\"47\",\"has_booking\":\"no\",\"hours\":\"closes 5pm weekdays closed weekends\",\"problem\":\"Phone-dependent, no online booking, 47 reviews means busy missing calls after 5pm\"}]. Do not include businesses without a confirmed real email."
