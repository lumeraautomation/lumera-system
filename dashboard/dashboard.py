...
<div class="modal-overlay" id="clientModal">
  <div class="modal" style="max-width:520px">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
      <div class="form-field"><label>Username *</label><input type="text" id="cl-user" placeholder="veturnai"/></div>
      <div class="form-field"><label>Password *</label><input type="text" id="cl-pass" placeholder="trial2026"/></div>
    </div>
    <div class="form-field"><label>Business Name *</label><input type="text" id="cl-biz" placeholder="Veturn AI"/></div>
    <div class="form-field"><label>What they sell</label><input type="text" id="cl-sell" placeholder="AI receptionist for restaurants"/></div>
    <div class="form-field"><label>Target niche *</label><input type="text" id="cl-niche" placeholder="restaurant"/></div>
    <div class="form-field"><label>Their booking / contact link</label><input type="text" id="cl-booking" placeholder="https://veturn.ai/contact"/></div>
